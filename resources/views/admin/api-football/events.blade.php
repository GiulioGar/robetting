...
@section('title', 'Admin — Sync Eventi/Marcatori API-Football')
...
<div class="row justify-content-center">
    <div class="col-lg-10">
        ...
        <div class="d-flex justify-content-between align-items-center mb-3">
            <h4 class="mb-0">Sync Eventi & Marcatori API-Football</h4>
            <div>
        ...
        <form method="POST" action="{{ route('admin.api-football.events.sync') }}">
            @csrf
            <div class="mb-4">
                <p class="text-muted small mb-2">
                    Recupera gol, cartellini, cambi e VAR per tutti i match definitivi della stagione
                    che non hanno ancora <code>events_fetched_at</code>. Una API call per match.
                    <br>
                    <strong>Nota:</strong> il tool <em>Aggiorna partita</em> nella dashboard forza sempre il ri-fetch
                    degli eventi indipendentemente dal sentinel.
                </p>
                <div class="row g-2 align-items-end">
                    ...
                    <div class="col-auto">
                        <button type="submit" class="btn btn-primary btn-sm">Sync Eventi</button>
                    </div>
                </div>
            </div>
        </form>
        ...
        @if($report)
            ...
            <h6 class="mb-3">
                ...
                &nbsp;<span class="badge bg-secondary">{{ $report['empty'] ?? 0 }} vuoti (no eventi)</span>
